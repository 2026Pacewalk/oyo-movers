            ...
            <div className="col-md-8 col-lg-8 col-xl-8 col-xxl-9">
              <div className="content-section">
                ...
                <div id="definitions">
                  ...
                  <div className="points ">
                    <p className="text-justify d-flex mb-2"><span>1.1&nbsp;</span><span><span className="font-weight-bold">“We”, “Us”, “Our”, “Oyo”, “Oyo Movers” and “Platform”</span> refers to Oyo Group Pty Ltd.</span></p>
                    ...
                    <p className="text-justify d-flex mb-2"><span>1.4&nbsp;</span><span><span className="font-weight-bold">“Goods”</span> refers to items being moved, delivered, or removed on customer request.</span></p>
                    <p className="text-justify d-flex mb-2"><span>1.5&nbsp;</span><span><span className="font-weight-bold">“Service”</span> refers to moving, delivery, junk removal or support provided by OYO.</span></p>
                  </div>
                </div>
                ...
                <div id="bookings">
                  ...
                  <div className="points ">
                    <p className="text-justify d-flex mb-2"><span>3.1&nbsp;</span><span>Bookings can be made via the OYO website or by calling us during business hours.</span></p>
                    <p className="text-justify d-flex mb-2"><span>3.2&nbsp;</span><span>Accurate pickup / delivery and job details are required (including item description).</span></p>
                    <p className="text-justify d-flex mb-2"><span>3.3&nbsp;</span><span>Booking is secured once confirmed by OYO only.</span></p>
                    <p className="text-justify d-flex mb-2"><span>3.4&nbsp;</span><span>Once booked, OYO will provide you reminders, updates and mover details. <span className="font-weight-bold">NOTE:</span> Arrival times are not guaranteed and may vary based on traffic, availability and prior jobs.</span></p>
                    <p className="text-justify d-flex mb-2"><span>3.5&nbsp;</span><span>Misuse of our platform or misrepresentation of goods may result in booking cancellation or legal action.</span></p>
                  </div>
                </div>
                ...
                <div id="move-size">
                  ...
                  <div className="points ">
                    ...
                    <p className="text-justify d-flex mb-2"><span>4.1&nbsp;</span><span><span className="font-weight-bold">Volume Calculator</span> – Estimate based on room count and furnishing level.</span></p>
                    <p className="text-justify d-flex mb-2"><span>4.2&nbsp;</span><span><span className="font-weight-bold">Inventory</span> – Estimate based on the items and boxes being moved.</span></p>
                    <p className="text-justify d-flex mb-2"><span>4.3&nbsp;</span><span><span className="font-weight-bold">Exact Volume</span> – If you already know the required cubic meters. Generally applicable if you moved recently.</span></p>
                    <p className="text-justify d-flex mb-2"><span>4.4&nbsp;</span><span><span className="font-weight-bold">Phone Estimate</span> – Based on your description of the items.</span></p>
                    <p className="text-justify d-flex mb-2"><span>4.5&nbsp;</span><span><span className="font-weight-bold">Photo / Video Review</span> – Estimate based on photos or videos you provide.</span></p>
                    <p className="text-justify mb-2">
                ...
                <div id="discount-codes">
                  ...
                  <div className="points ">
                    <p className="text-justify d-flex mb-2"><span>7.1&nbsp;</span><span>Only one discount code or voucher can be applied per booking.</span></p>
                    <p className="text-justify d-flex mb-2"><span>7.2&nbsp;</span><span>Vouchers & discount codes do not apply on Sundays, Public Holidays & Peak Times.</span></p>
                  </div>
                </div>
                ...
                <div id="responsibilities">
                  ...
                  <div className="points ">
                    <p className="text-justify d-flex mb-2"><span>8.1&nbsp;</span><span><span className="font-weight-bold">Presence:</span> Be present during loading/unloading to ensure no items are left behind or taken in error.</span></p>
                    <p className="text-justify d-flex mb-2"><span>8.2&nbsp;</span><span><span className="font-weight-bold">Owner of Goods:</span> You must be the owner of the Goods or authorised by the owner.</span></p>
                    <p className="text-justify d-flex mb-2"><span>8.3&nbsp;</span><span><span className="font-weight-bold">Restricted Items:</span> Goods must not include dangerous, hazardous, or illegal items.</span></p>
                    <p className="text-justify d-flex mb-2"><span>8.4&nbsp;</span><span><span className="font-weight-bold">Parking:</span> Safe parking space or permits are arranged close to the property. Parking fines or fees incurred will be added to the bill.</span></p>
                    <p className="text-justify d-flex mb-2"><span>8.5&nbsp;</span><span><span className="font-weight-bold">Ensure:</span> Items will fit into the new property (e.g. a large sofa fits through the doors).</span></p>
                    <p className="text-justify d-flex mb-2"><span>8.6&nbsp;</span><span><span className="font-weight-bold">Notify us:</span> Of any access issues, heavy items or special handling requirements. Bad access includes narrow stair flights, awkward access, long walking distance from the parked truck, etc. Please note, additional costs may apply due to unforeseen circumstances.</span></p>
                    <p className="text-justify d-flex mb-2"><span>8.7&nbsp;</span><span><span className="font-weight-bold">Liquids:</span> Appliances, lawn equipment & plants must be drained of liquids.</span></p>
                    <p className="text-justify d-flex mb-2"><span>8.8&nbsp;</span><span><span className="font-weight-bold">Arrange a Specialist:</span> For tasks such as removing doors or windows, disconnecting whitegoods, or handling property fittings that require licensed trades (e.g. plumbers or carpenters). If you request assistance with such tasks, you accept full responsibility for any loss or damage and agree to indemnify OYO and its service providers.</span></p>
                    <p className="text-justify d-flex mb-2"><span>8.9&nbsp;</span><span><span className="font-weight-bold">Final Walk-through:</span> Upon completion of the move, you must inspect the property and items with the team before signing off. All damage claims or property issues must be reported before the team departs the premises to avoid any confusion.</span></p>
                  </div>
                </div>
                ...
                <div id="off-platform">
                  ...
                  <div className="points ">
                    <p className="text-justify d-flex mb-2"><span>9.1&nbsp;</span><span><span className="font-weight-bold">Payments Through OYO only:</span> You must make all payments exclusively through the official OYO platform. You must not offer, negotiate, or make any direct payments (cash, external bank transfers, or private card transactions) to Service Providers.</span></p>
                    <p className="text-justify d-flex mb-2"><span>9.2&nbsp;</span><span><span className="font-weight-bold">Off-Platform Arrangements:</span> Any payment or arrangement made directly with a service provider outside the OYO platform is immediately considered an unauthorised private arrangement. This completely voids all or any applicable insurance coverage, damage claim eligibility, and dispute resolution support from OYO, and constitutes a breach of our safety protocols.</span></p>
                  </div>
                </div>
                ...
                <div id="additional-movers">
                  ...
                  <div className="points ">
                    <p className="text-justify d-flex mb-2"><span>10.1&nbsp;</span><span>If your move requires more resources than originally booked (such as an additional truck or extra movers), a separate booking must be made, and these resources will be billed separately.</span></p>
                    <p className="text-justify d-flex mb-2"><span>10.2&nbsp;</span><span>All additional resources are subject to availability at the time of request.</span></p>
                    <p className="text-justify d-flex mb-2"><span>10.3&nbsp;</span><span>If you choose to continue with the original resources, the job may take longer and require you to prioritise which items are moved first.</span></p>
                  </div>
                </div>
                ...
                <div id="conduct-safety">
                  ...
                  <div className="points ">
                    <p className="text-justify d-flex mb-2"><span>11.1&nbsp;</span><span><span className="font-weight-bold">Zero-Tolerance:</span> OYO has zero tolerance for threatening, abusive, aggressive, discriminatory or harassing behaviour towards OYO staff or Service Providers.</span></p>
                    <p className="text-justify d-flex mb-2"><span>11.2&nbsp;</span><span>OYO or the Service Provider may pause, refuse or stop services where such behaviour occurs and may restrict the Customer’s future use of the Platform.</span></p>
                    <p className="text-justify d-flex mb-2"><span>11.3&nbsp;</span><span>If services are terminated under this clause, the Customer remains liable for all work time, travel fees, and costs incurred up to the stoppage point. OYO and its Service Providers accept no liability for resulting delays or expenses, and OYO reserves the right to permanently ban the Customer’s account.</span></p>
                  </div>
                </div>
                ...
                <div id="provider-rights">
                  ...
                  <div className="points ">
                    ...
                    <p className="text-justify d-flex mb-2"><span>12.1&nbsp;</span><span>The job site or item is unsafe.</span></p>
                    <p className="text-justify d-flex mb-2"><span>12.2&nbsp;</span><span>The job is materially different from the service booked.</span></p>
                    <p className="text-justify d-flex mb-2"><span>12.3&nbsp;</span><span>Moving an item poses an unreasonable risk of injury or property damage.</span></p>
                    <p className="text-justify d-flex mb-2"><span>12.4&nbsp;</span><span>Additional Movers, vehicles, equipment or trips are required.</span></p>
                    <p className="text-justify d-flex mb-2"><span>12.5&nbsp;</span><span>If extra resources or a different approach is required, the mover will discuss the available options and any additional charges with you when reasonably possible.</span></p>
                    <p className="text-justify d-flex mb-2"><span>12.6&nbsp;</span><span>If a significant risk of damage exists, movers may require you to sign a waiver before proceeding.</span></p>
                  </div>
                </div>
